...
import Filter13 from './Fliter13';

let data = {
	fox: [
		{
			id: '1',
			image: require('../assets/applcon.png'),
		},
	],
	crown: [
		{
			...
			<View style={styles.container}>
				...
				<View style={styles.cameraStyle}>
					...
					{this.state.faces.map((face) => {
						...
						} else if (this.state.current_filter === 'filter_13') {
							return <Filter13 key={face.faceID} face={face} />;
						}
					})}
				</View>
				<View style={styles.framesContainer}>
					<View style={styles.categoryContainer}>
						<TouchableOpacity
							style={
								this.state.selected == 'fox'
									? styles.categoryBoxSelected
									: styles.categoryBox
							}
							onPress={() => this.setState({ selected: `fox` })}>
							<Text>Regular</Text>
						</TouchableOpacity>
						<TouchableOpacity
							style={
						...
						<TouchableOpacity
							style={
								this.state.selected == 'horns'
									? styles.categoryBoxSelected
									: styles.categoryBox
							}
							onPress={() => this.setState({ selected: `horns` })}>
							<Text>Aviator</Text>
						</TouchableOpacity>
					</View>
					<ScrollView
